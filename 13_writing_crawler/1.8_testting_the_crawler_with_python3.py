...
import requests
import re
import urllib.parse as urlparse  ## this library print the full url of the website.
...
def extract_link_from(url):
    ...
    return re.findall('(?:href=")(.*?)"', response.content.decode(errors="ignore")) ## errors="ignore". this is a ignore any errors.
def crawl(url):
