...
def scan(ip): # this is a define a scapy function
    ...
    answerd, unanswerd = scapy.srp(arp_request_broadcast,timeout=1) #.srp() function for scapy he is sending and receiving packets. this srp use for two values answerd and unanswered.
